...
class NG(object):
    ...
    def train(self, data):
        ...
        for t in range(self.END):
            ...
            # Move the units towards the input.
            ...
            # Determin the nearest and the second nearest units.
            ...
            for i in list(g_units.neighbors(n_1)):
                ...
                # Remove the edge of the nearest neighbor with age > lifetime, if unit n_1 or i has more one edges.
